...
class ProdutoRepositorio
{
    ...
    public function deletar(int $id)
    {
        ...
        /**
         * O método prepare() doPDO prepara o sql antes da execução. Assim é possível substituir 
         * o interrogação pelo parâmetro
         */
        $statement = $this->pdo->prepare($sql);
        /**
         * O método bindValue substitui o primeiro parâmetro encontrado pela variávei indicada
         * Dessa forma, previne contra SQL Injection
         */
        $statement->bindValue(1,$id);
        /**
         * Executa efetivamente o SQL
         */
        $statement->execute();
